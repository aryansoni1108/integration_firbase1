...
public class CrossfadeDrawerLayout extends AppCompatActivity {

    private AccountHeader headerResult = null;
    private Drawer result = null;
    private com.mikepenz.crossfadedrawerlayout.view.CrossfadeDrawerLayout crossfadeDrawerLayout = null;
...
//
                        switch (position){
                            case 1:
                                Toast.makeText(getBaseContext(),"Class 1 efwf",Toast.LENGTH_SHORT).show();break;
        ...
        crossfadeDrawerLayout = (com.mikepenz.crossfadedrawerlayout.view.CrossfadeDrawerLayout) result.getDrawerLayout();
